...
class YandexRelated
{
    ...
    public static function getAll(string $param = null, $page = 1, $orderBy = 'id', $order = 'DESC')
    {
        ...
        return $wpdb->get_results("SELECT wp_posts.id as id, wp_posts.post_title as title, count(wp_yandex_related.related_article_id) as count_related_article_id, wp_posts.post_name as url, wp_yandex_related.updated_at as updated_at FROM wp_posts RIGHT JOIN " . self::$table . " as wp_yandex_related ON wp_posts.id = wp_yandex_related.article_id " . $where . " GROUP BY wp_yandex_related.article_id ORDER BY wp_posts." . $orderBy . " " . $order . " LIMIT " . $limit . " OFFSET " . $offset);
    }
